...
function Home() {
  ...
  const handleLogout = async () => {
    try {
      await axios.post(
        "https://music-stream-ub1v.onrender.com/api/auth/logout",
      );
          ...
          {!user ? (
            <div className="flex gap-2 sm:gap-4">
              ...
              <button
                ...
                className="bg-white text-black px-4 sm:px-6 py-2 rounded-full text-sm font-bold hover:bg-zinc-200 transition shadow-lg"
              >
                Sign Up
              </button>
            </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <button
                ...
                className="border border-red-500/50 text-red-500 px-4 py-1.5 rounded-full text-xs font-semibold hover:bg-red-500 hover:text-white transition"
              >
                Logout
              </button>
            </div>
